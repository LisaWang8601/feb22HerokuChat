            ...
            case GameState.NUMBER:
                ...
                if ((nInput >= 10)||(nInput <= 0)) {     // input validation
                    ...
                    // the number given by user is compared with a random number to decide which state is next.  
                        ...
                        sReply = "Great you got the " + aAnimals[i] + "! Now you are full. Would you rest near your leftover or walk around to guard your territory."
                ...
                case GameState.FARM:
                    if(sInput.toLowerCase().match("go") || sInput.toLowerCase().match("attack")){
                        ...
                        sReply ="The farmer was after you with a gun. Fortunately you still got away. Now would you rest and wait for prey or go hunting";
                        this.stateCur = GameState.STILL_HUNGARY;
                        break;
                        } 
                    else if (sInput.toLowerCase().match("carry")){
                        this.stateCur = GameState.FARMER_NO_GUN;
                        sReply = "Luckily you got away with the goat. Now you are full. Would you rest near your leftover or walk in the forest to guard your territory?";
                        break;
                    }
                    else{
                        sReply = "Your answer needs to contain go or ..., please.";
                        this.stateCur = GameState.FARM;
                        break;
                        }
